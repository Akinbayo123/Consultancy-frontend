(function ($) {
  ...
  if ($(".main-menu__home-three").find(".main-menu__list").length) {
    let dropdownAnchor = $(
      ".main-menu__home-three .main-menu__list .dropdown > a"
    );
    dropdownAnchor.each(function () {
      let self = $(this);
      let toggleBtn = document.createElement("BUTTON");
  ...
  function projectMasonaryLayout() {
    ...
    if ($(".fitRows-layout").length) {
      $(".fitRows-layout").isotope({
        layoutMode: "fitRows",
        itemSelector: ".fitRows-item"
      });
    }
